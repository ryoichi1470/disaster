...
class SheltersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shelter" do
    assert_difference('Shelter.count') do
      post shelters_url, params: { shelter: { address: @shelter.address, capacity: @shelter.capacity, facilities: @shelter.facilities, latitude: @shelter.latitude, longitude: @shelter.longitude, name: @shelter.name } }
    end
  ...
  test "should update shelter" do
    patch shelter_url(@shelter), params: { shelter: { address: @shelter.address, capacity: @shelter.capacity, facilities: @shelter.facilities, latitude: @shelter.latitude, longitude: @shelter.longitude, name: @shelter.name } }
